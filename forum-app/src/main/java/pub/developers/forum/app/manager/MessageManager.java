...
public class MessageManager {
    ...
    public PageResponseModel<MessagePageResponse> page(PageRequestModel<MessagePageRequest> pageRequestModel) {
        ...
        // 根据 pageResult.getList 查找users posts
        // 先获取  userIds postsIds
        ...
        List<MessagePageResponse> responses = MessageTransfer.toMessagePageResponses(pageResult.getList(),
                users, postsList, LoginUserContext.getUser());
