...
public class ArticleManager extends AbstractPostsManager {
    ...
    private PageResponseModel<ArticleUserPageResponse> pageQuery(PageRequestModel pageRequestModel,
                                                                 PostsPageQueryValue pageQueryValue) {
        pageQueryValue.setCategory(PostsCategoryEn.ARTICLE.getValue());

        PageResult<Article> pageResult = articleRepository.page(pageRequestModel.getPageNo(),
                pageRequestModel.getPageSize(), pageQueryValue);

        List<ArticleUserPageResponse> responses = ArticleTransfer.toArticleUserPageResponses(pageResult.getList());
