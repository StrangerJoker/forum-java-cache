...
public class WebUtil {
    ...
    /**
     * 根据 List<ArticleUserPageResponse> 返回页面需要的数据
     * @param responses
     * @return
     */
    ...
    /**
     * 加载配置信息（轮播图）
     * @param configResponses ConfigResponse
     * @param configType configType配置类型
     * @return
     */
    public List<Map<String, Object>> carouselList(List<ConfigResponse> configResponses,
                                                  ConfigTypeEn configType) {
